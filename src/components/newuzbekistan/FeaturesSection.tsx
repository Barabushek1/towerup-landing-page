...
const Feature: React.FC<FeatureProps> = ({ icon, title, description, delay }) => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center text-center p-6 transition-all duration-300 hover:bg-white hover:shadow-lg rounded-xl"
    >
...
const FeaturesSection: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <ParkingCircle className="h-8 w-8 text-indigo-600" />,
