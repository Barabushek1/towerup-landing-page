...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 bg-[#161616] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="lg:order-2">
            <motion.div 
              className="bg-[#1a1a1a] p-8 rounded-lg shadow-xl border border-slate-700/30"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
...
Ориентир: Моторный завод GM.</p>
                ...
                <motion.div className="mt-8" variants={itemVariants}>
                  ...
                  <div className="flex space-x-4">
                    <a 
                      href="#" 
                      className="bg-slate-800 p-3 rounded-full hover:bg-primary/20 transition-colors transform hover:scale-110 transition-transform duration-300"
                    >
                ...
                {/* 3D card effect */}
                <motion.div 
                  className="mt-12 p-6 bg-gradient-to-br from-primary/20 to-slate-800/80 rounded-xl border border-slate-700/30"
                ...
                >
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-300">Понедельник - Пятница:</span>
                      <span className="text-white">9:00 - 18:00</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">Суббота:</span>
                      <span className="text-white">10:00 - 16:00</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">Воскресенье:</span>
