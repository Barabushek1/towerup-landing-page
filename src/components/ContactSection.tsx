...
import { Phone, Mail, MapPin, Send, Check, Plane, Youtube } from 'lucide-react';
              ...
              <div className="space-y-8">
                ...
                <motion.div className="mt-8" variants={itemVariants}>
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/share/18xM4NRVzW/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-primary/20 transition-colors transform hover:scale-110 transition-transform duration-300">
                    ...
                    <a href="https://www.instagram.com/yangi_ozbekiston_massiv" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-primary/20 transition-colors transform hover:scale-110 transition-transform duration-300">
                    ...
                    <a href="https://t.me/towerupuz" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-primary/20 transition-colors transform hover:scale-110 transition-transform duration-300">
                      <Plane className="h-5 w-5 text-white" />
                    </a>
                    <a href="https://youtube.com/@towerup_uz" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-3 rounded-full hover:bg-primary/20 transition-colors transform hover:scale-110 transition-transform duration-300">
