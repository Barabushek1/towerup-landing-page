...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:shadow-sm",
      "data-[state=inactive]:text-gray-400 data-[state=inactive]:hover:text-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-primary/50",
      className
    )}
    {...props}
  />
  ...
  "3-комнатные": [
    {
      ...
      areaNum: 78.4,
      areaLabel: "площадь",
      image: "/lovable-uploads/b7b815c6-44d8-4e9a-93e9-75538f6d0233.png"
    },
    {
      id: 6,
      title: "3-комнатная",
    ...
    <section id="floor-plans" className="py-16 bg-[#161616]">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center mb-12">
          ...
          <h3 className="text-xl sm:text-2xl font-medium mb-8 text-center text-white">МАССИВ УЗБЕКИСТАН</h3>
                              ...
                              <div className="p-5 sm:p-6 mt-auto">
                                <div className="mb-4">
                                  ...
                                  <p className="text-white/60 text-xs sm:text-sm flex items-center gap-1">
                                    ...
                                    {formatNumberWithSpaces(PRICE_PER_SQM)} сум/м²
                                  </p>
                                </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-white/60 text-sm">
                        Узнайте условия рассрочки у менеджера
                      </p>
                    </div>
