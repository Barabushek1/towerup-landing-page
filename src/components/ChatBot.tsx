        ...
        * А также форма для отправки сообщения на странице Контакты, которая находится в конце главной страницы или же в навигационном меню.
        ...
        try {
            ...
            const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${API_KEY}`, {
                ...
                body: JSON.stringify({
                    contents: messagesForApi, // Send session history + new message
                ...
                <div className="fixed bottom-24 right-6 md:right-10 z-[9998] bg-white rounded-lg shadow-xl w-full max-w-[350px] md:max-w-[400px] h-[500px] flex flex-col border border-gray-200 animate-fade-in">
                    ...
                    <div className="flex-grow p-4 overflow-y-auto bg-gray-50">
                        {messages.map((msg, index) => (
                             <div key={`${msg.role}-${index}-${msg.content.slice(0, 10)}`} // Slightly better key
                    ...
                    <div className="p-3 border-t bg-white rounded-b-lg">
                         <div className="flex gap-2">
                            <input
                                ...
                                disabled={isLoading}
                                className="flex-grow rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm bg-white" // Changed input bg back to white
                            />
                            <Button
