...
const ChatBot: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    const systemPrompt = `
        ...
        **Массив "Янги Узбекистан"** (в процессе строительства):
        ...
        **БЦ «Бочка»** (завершен):
        • Расположение: Ташкентская область, Бочка
        • Этажность: 5 этажей
        • Класс: А
