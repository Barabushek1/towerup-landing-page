...
const AdminYangiUzbekistanApartmentUnits: React.FC = () => {
    ...
    <AdminLayout>
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-bold">Управление квартирами ЖК "Янги Узбекистан"</h1>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle>Список квартир ЖК "Янги Узбекистан"</CardTitle>
...
export default AdminYangiUzbekistanApartmentUnits;
