          ...
          <Form {...loginForm}>
            <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <Input placeholder="Enter your email" type="email" className="bg-slate-700 border-slate-600 text-white" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              ...
              field
                    ...
                    <FormControl>
                      <Input placeholder="••••••••" type="password" className="bg-slate-700 border-slate-600 text-white" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
