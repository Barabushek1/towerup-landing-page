...
const AdminYangiUzbekistanFloorPrices: React.FC = () => {
  ...
  return (
    <AdminLayout title="Цены за м² (Янги Узбекистан)">
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Цены за м² (Янги Узбекистан)</h2>
...
export default AdminYangiUzbekistanFloorPrices;
