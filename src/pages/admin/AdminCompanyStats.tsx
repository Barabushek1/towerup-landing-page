          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                {editing 
                  ...
                  : 'Fill in the details below to add a new statistic to the homepage.'}
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="subtitle"
                  value={currentStat.subtitle || ''}
                  onChange={(e) => setCurrentStat({ ...currentStat, subtitle: e.target.value })}
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setCurrentStat({ ...currentStat, is_active: checked })}
                />
            ...
            <TableBody>
              {stats.map((stat, index) => (
                <TableRow key={stat.id}>
                  ...
                  <TableCell>{stat.subtitle}</TableCell>
                  <TableCell>{stat.icon}</TableCell>
                  <TableCell>
                    <Switch
                      checked={stat.is_active}
                      onCheckedChange={() => handleToggleActive(stat.id, stat.is_active)}
                    />
                  </TableCell>
                  <TableCell>
