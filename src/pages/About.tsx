...
const About: React.FC = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Сроки зависят от масштаба проекта. Типичный жилой комплекс мы строим за 18-36 месяцев. На перви��ной консультации мы предоставляем детальный график работ."
    }
  ];
