      ...
      <main>
          ...
          <div className="container mx-auto px-6">
            <motion.div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4 md:gap-10" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{
              ...
              {stats.map((stat, index) => (
                <motion.div key={index} variants={fadeInUp} className="bg-[#1E1E1E] p-4 sm:p-6 md:p-8 rounded-lg border border-white/5 text-center hover:border-primary/30 transition-all duration-300 transform hover:translate-y-[-5px]">
        ...
        <section className="py-16 md:py-24 bg-[#1a1a1a] overflow-hidden">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Наши текущие проекты</h2>
              <div className="h-1 w-20 bg-primary mx-auto mb-8"></div>
              <p className="text-gray-300 max-w-3xl mx-auto mb-8">
                Познакомьтесь с нашими инновационными проектами, которые в настоящее время находятся в стадии реализации.
                Эти знаковые объекты демонстрируют наш подход к современному строительству.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6 relative">
            ...
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{
              ...
              {values.map((value, index) => (
                <motion.div key={index} variants={fadeInUp} whileHover={{
                  y: -10,
        ...
        <section className="py-16 md:py-24 bg-[#1a1a1a]">
          <div className="container mx-auto px-6">
            ...
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{
              ...
              {[1, 2, 3, 4].map(member => (
                <motion.div key={member} variants={fadeInUp} className="bg-[#1E1E1E] rounded-lg overflow-hidden border border-white/5 hover:border-primary/20 transition-all duration-300">
