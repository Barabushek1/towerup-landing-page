        ...
        <section className="py-16 md:py-24 bg-[#161616] overflow-hidden" ref={timelineRef}>
          <div className="container mx-auto px-6 relative">
            ...
            <div className="max-w-5xl mx-auto relative">
              ...
              <motion.div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 top-0 h-4 w-4 bg-primary rounded-full shadow-lg shadow-primary/50 z-20" animate={{
              y: ['0%', '100%'],
              opacity: [1, 1, 0]
            }} transition={{
              duration: 8,
              ...
              {timeline.map((item, index) => <motion.div key={index} className={`timeline-item relative mb-20 md:mb-32 opacity-0`} initial="hidden" whileInView={index % 2 === 0 ? "visible" : "visible"} viewport={{
              once: true,
              margin: "-100px"
            }} variants={index % 2 === 0 ? fadeInRight : fadeInLeft} custom={index}>
                  <div className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                    ...
                    <motion.div className={`md:w-[calc(100%-120px)] bg-[#1E1E1E] p-6 rounded-lg shadow-lg border border-white/5 ${index % 2 === 0 ? 'md:ml-10' : 'md:mr-10'}`} whileHover={{
                  y: -5
                }} transition={{
                  type: "spring",
                  stiffness: 300,
                  damping: 20
                      ...
                      <motion.div className="h-0 overflow-hidden mt-4 bg-[#191919] rounded-md" initial={{
                    opacity: 0,
                    height: 0
                  }} whileHover={{
                    opacity: 1,
