...
const Construction: React.FC = () => {
  return (
    <ServicePageLayout
      title="Строительство"
      description="Строительство объектов любой сложности от компании TOWERUP"
      breadcrumb="Услуги / Строительство"
      headerImage="/lovable-uploads/a752d5ec-95e4-49b3-acce-7ba19b32877c.png"
    >
      {/* Hero Section */}
          ...
          <AnimatedSection className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeIn} className="relative">
              <div className="aspect-square overflow-hidden rounded-2xl border-2 border-white/10 shadow-2xl">
                <img 
                  src="/lovable-uploads/157f2478-432c-4018-8f8e-5d9e9b555043.png" 
                  alt="Строительство TOWERUP"
              ...
              <div className="absolute -top-6 -right-6 w-2/3 h-2/3 rounded-xl overflow-hidden border-2 border-white/10 shadow-lg">
                <img 
                  ...
                  alt="Строительство зданий TOWERUP"
                  className="w-full h-full object-cover"
                />
              </div>
            </motion.div>
