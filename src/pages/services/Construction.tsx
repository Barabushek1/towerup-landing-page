    ...
    >
          ...
          <AnimatedSection className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeIn} className="relative">
              <div className="aspect-square overflow-hidden rounded-2xl border-2 border-white/10 shadow-2xl">
                <img alt={t("hero.image_alt")} className="w-full h-full object-cover" src="/lovable-uploads/7bdf99aa-2b8a-47f6-83d2-abd294990266.jpg" />
              </div>
            </motion.div>
          </AnimatedSection>
        </div>
              ...
              {[
                {
                  ...
                  titleKey: "services.residential_construction.title",
                  descriptionKey: "services.residential_construction.description",
                },
                {
                  icon: <Building className="h-6 w-6 text-primary" />,
                  titleKey: "services.commercial_construction.title",
                  descriptionKey: "services.commercial_construction.description",
                },
                {
                  icon: <Building className="h-6 w-6 text-primary" />,
                  titleKey: "services.industrial_construction.title",
                  descriptionKey: "services.industrial_construction.description",
                },
                {
                  icon: <Wrench className="h-6 w-6 text-primary" />,
                  titleKey: "services.engineering_networks.title",
                  descriptionKey: "services.engineering_networks.description",
                },
                {
                  icon: <Clock className="h-6 w-6 text-primary" />,
                  titleKey: "services.construction_management.title",
                  descriptionKey: "services.construction_management.description",
                },
                {
                  icon: <FileText className="h-6 w-6 text-primary" />,
                  titleKey: "services.construction_consulting.title",
                  descriptionKey: "services.construction_consulting.description",
                },
              ].map((service, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-20 md:py-24 bg-gradient-to-b from-[#1a1a1a] to-[#161616] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <AnimatedSection>
            <motion.div variants={fadeIn} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{t("why_choose_us.title")}</h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              ...
              {[
                {
                  ...
                  titleKey: "why_choose_us.quality_guarantee.title",
                  descriptionKey: "why_choose_us.quality_guarantee.description",
                },
                {
                  icon: <Clock className="h-8 w-8 text-primary" />,
                  titleKey: "why_choose_us.deadline_adherence.title",
                  descriptionKey: "why_choose_us.deadline_adherence.description",
                },
                {
                  icon: <Users className="h-8 w-8 text-primary" />,
                  titleKey: "why_choose_us.professional_team.title",
                  descriptionKey: "why_choose_us.professional_team.description",
                },
                {
                  icon: <Building className="h-8 w-8 text-primary" />,
                  titleKey: "why_choose_us.integrated_approach.title",
                  descriptionKey: "why_choose_us.integrated_approach.description",
                },
                {
                  icon: <Wrench className="h-8 w-8 text-primary" />,
                  titleKey: "why_choose_us.modern_technologies.title",
                  descriptionKey: "why_choose_us.modern_technologies.description",
                },
                {
                  icon: <FileText className="h-8 w-8 text-primary" />,
                  titleKey: "why_choose_us.transparent_reporting.title",
                  descriptionKey: "why_choose_us.transparent_reporting.description",
                },
              ].map((advantage, index) => (
                <motion.div
                  key={index}
        ...
        <div className="container mx-auto px-6">
          <AnimatedSection>
              ...
              {[
                {
                  ...
                  titleKey: "projects.trc_bochka.title",
                  categoryKey: "projects.category_commercial",
                },
                {
                  image: "/lovable-uploads/d2bd2619-426f-4ab0-95ad-ed8b140aa758.png",
                  titleKey: "projects.new_uzbekistan_residential.title",
                  categoryKey: "projects.category_residential",
                },
                {
                  image: "/lovable-uploads/38cd93b4-a24c-4390-bd04-0ed51282d778.png",
                  titleKey: "projects.pushkin_plaza.title",
                  categoryKey: "projects.category_multifunctional",
                },
              ].map((project, index) => (
            ...
            <motion.div variants={fadeIn} className="mt-12 text-center">
              <Button variant="outline" size="lg" className="border-white/20 hover:bg-white/10">
                {t("projects.button_all_projects")}
              </Button>
            </motion.div>
          </AnimatedSection>
        </div>
