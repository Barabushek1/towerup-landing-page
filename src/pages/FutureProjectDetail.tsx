        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              {(project.galleryImages && project.galleryImages.length > 0) && (
                <div className="grid grid-cols-4 gap-3">
                  {project.coverImage && (
                    <button 
                      onClick={() => setActiveImage(project.coverImage || null)}
                      className={`rounded-md overflow-hidden h-20 ${activeImage === project.coverImage ? 'ring-2 ring-primary' : ''}`}
                    >
                      <img 
                  ...
                  {project.galleryImages.map((img, index) => (
                    <button 
                      ...
                      className={`rounded-md overflow-hidden h-20 ${activeImage === img ? 'ring-2 ring-primary' : ''}`}
                    >
                      <img 
                        src={img} 
                        alt={`Gallery ${index + 1}`} 
            ...
            <div>
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">{t('futureProjects.location')}</p>
                      <p className="font-medium">{project.location || t('futureProjects.locationNotSpecified')}</p>
                    </div>
                  </div>
              ...
              {project.features && project.features.length > 0 && project.features.some(f => f.title || f.description) && (
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-3">
                    {project.features.filter(f => f.title || f.description).map((feature, index) => (
